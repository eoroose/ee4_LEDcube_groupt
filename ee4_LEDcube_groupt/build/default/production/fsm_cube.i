...
# 4 "/Applications/microchip/xc8/v2.05/pic/include/__size_t.h"
typedef unsigned size_t;

# 7 "/Applications/microchip/xc8/v2.05/pic/include/c90/stdlib.h"
...
else if((PORTCbits.RC6==1)&&(PORTCbits.RC7==1)){
...
game_time = 0;
current_state = FSM_WAIT1;
}else if((game_time>=wait_time)||(buttonpressed()==1)){
game_time = 0;
...
if((PORTCbits.RC1==1)&&(PORTCbits.RC2==1)&&(PORTCbits.RC6==1)&&(PORTCbits.RC7==1)&&(PORTBbits.RB0==0)&&(PORTBbits.RB1==0))
{
game_time=0;
...
if((PORTCbits.RC2==0)&&(PORTCbits.RC1==0)&&(PORTCbits.RC6==0)&&(PORTCbits.RC7==1)){
melody_index=0;
game_time = 0;
loser = 3;
current_state = FSM_DEAD2;
}else if((PORTCbits.RC2==0)&&(PORTCbits.RC1==0)&&(PORTCbits.RC6==1)&&(PORTCbits.RC7==0)){
melody_index=0;
game_time = 0;
loser = 2;
current_state = FSM_DEAD2;
}else if((PORTCbits.RC2==0)&&(PORTCbits.RC1==1)&&(PORTCbits.RC6==0)&&(PORTCbits.RC7==0)){
melody_index=0;
game_time = 0;
loser = 1;
current_state = FSM_DEAD2;
}else if((PORTCbits.RC2==1)&&(PORTCbits.RC1==0)&&(PORTCbits.RC6==0)&&(PORTCbits.RC7==0)){
melody_index=0;
game_time = 0;
loser = 0;
current_state = FSM_DEAD2;
...
char buttonpressed(void){
if((PORTCbits.RC2==1)||(PORTCbits.RC1==1)||(PORTCbits.RC6==1)||(PORTCbits.RC7==1)||(PORTBbits.RB0==1)||(PORTBbits.RB1==1)){
return 1;
}else{
return 0;
}
